...
const ALL_SOURCES: Record<string, (key: string) => Promise<ScrapedArticle[]>> = {
  ...
  /* ── Historical archives & memo libraries (1999–present) ── */
  // Democratic / progressive historical messaging memo archives
  dlc_archive: makeSearchScraper("web.archive.org/web/*/dlc.org", "messaging memo strategy new democrat third way", "Democratic Leadership Council (Archive)", "Democrat", "message-guidance", 3),
  ndn_archive: makeSearchScraper("web.archive.org/web/*/ndn.org", "messaging memo polling strategy electorate", "NDN Archive", "Democrat", "polling-memo", 3),
  greenberg_quinlan: makeSearchScraper("gqrr.com", "polling memo democratic strategy battleground", "Greenberg Quinlan Rosner", "Democrat", "polling-memo", 3),
  benenson: makeSearchScraper("benensonstrategygroup.com", "polling messaging democratic strategy memo", "Benenson Strategy Group", "Democrat", "polling-memo", 2),
  global_strategy: makeSearchScraper("globalstrategygroup.com", "polling messaging democratic memo strategy", "Global Strategy Group", "Democrat", "polling-memo", 2),
  garin_hart_yang: makeSearchScraper("hartresearch.com", "peter hart democratic polling messaging memo", "Hart Research / Garin-Hart-Yang", "Democrat", "polling-memo", 2),
  lake_research: makeSearchScraper("lakeresearch.com", "celinda lake democratic polling messaging women voters", "Lake Research Partners", "Democrat", "polling-memo", 3),
  anzalone_liszt: makeSearchScraper("anzaloneresearch.com", "polling memo democratic messaging strategy", "Anzalone Liszt Grove Research", "Democrat", "polling-memo", 2),
  dccc_archive: makeSearchScraper("web.archive.org/web/*/dccc.org", "messaging strategy memo congressional democrat", "DCCC (Archive)", "Democrat", "message-guidance", 2),
  dscc_archive: makeSearchScraper("web.archive.org/web/*/dscc.org", "messaging strategy memo senate democrat", "DSCC (Archive)", "Democrat", "message-guidance", 2),
  dnc_archive: makeSearchScraper("web.archive.org/web/*/democrats.org", "messaging memo strategy platform democrat", "DNC (Archive)", "Democrat", "message-guidance", 2),
  center_amer_progress_archive: makeSearchScraper("web.archive.org/web/*/americanprogress.org", "messaging memo polling strategy historical", "CAP Historical Archive", "Democrat", "message-guidance", 2),
  third_way_archive: makeSearchScraper("web.archive.org/web/*/thirdway.org", "messaging memo polling strategy historical", "Third Way Historical Archive", "Democrat", "polling-memo", 2),
  brock_mediamatters: makeSearchScraper("mediamatters.org", "messaging media accountability research progressive", "Media Matters for America", "Democrat", "message-guidance", 2),
  americans_united: makeSearchScraper("americansunitedforchange.org", "progressive messaging campaign strategy memo", "Americans United for Change", "Democrat", "message-guidance", 2),
  herndon_alliance: makeSearchScraper("web.archive.org/web/*/herndonalliance.org", "healthcare messaging framing public option historical", "Herndon Alliance (Archive)", "Democrat", "message-guidance", 2),
  enough_project: makeSearchScraper("enoughproject.org", "human rights advocacy messaging progressive", "Enough Project", "Democrat", "message-guidance", 2),
  rockridge: makeSearchScraper("web.archive.org/web/*/rockridgeinstitute.org", "framing progressive messaging lakoff strategy", "Rockridge Institute (Archive)", "Democrat", "message-guidance", 2),
  topos_partnership: makeSearchScraper("topospartnership.com", "framing communications research nonprofit progressive", "Topos Partnership", "Democrat", "message-guidance", 2),
  frameworks_institute: makeSearchScraper("frameworksinstitute.org", "strategic framing communications social issue", "FrameWorks Institute", "Independent", "message-guidance", 3),
  shorenstein: makeSearchScraper("shorensteincenter.org", "media politics public policy research messaging", "Shorenstein Center (Harvard)", "Independent", "policy-analysis", 2),

  // Republican / conservative historical messaging memo archives
  luntz_archive: makeSearchScraper("luntzglobal.com", "frank luntz messaging language framing word", "Luntz Global", "Republican", "message-guidance", 3),
  luntz_words: makeSearchScraper("web.archive.org/web/*/luntz.com", "luntz language words working messaging memo historical", "Luntz Research (Archive)", "Republican", "message-guidance", 3),
  rnc_archive: makeSearchScraper("web.archive.org/web/*/gop.com", "messaging memo strategy platform republican", "RNC (Archive)", "Republican", "message-guidance", 2),
  nrcc_archive: makeSearchScraper("web.archive.org/web/*/nrcc.org", "messaging memo strategy congressional republican", "NRCC (Archive)", "Republican", "message-guidance", 2),
  nrsc_archive: makeSearchScraper("web.archive.org/web/*/nrsc.org", "messaging memo strategy senate republican", "NRSC (Archive)", "Republican", "message-guidance", 2),
  heritage_archive: makeSearchScraper("web.archive.org/web/*/heritage.org", "messaging memo conservative strategy historical", "Heritage Archive", "Republican", "message-guidance", 2),
  aei_archive: makeSearchScraper("web.archive.org/web/*/aei.org", "messaging polling memo historical conservative", "AEI Historical Archive", "Republican", "polling-memo", 2),
  contract_with_america: makeSearchScraper("web.archive.org/web/*/contractwithamerica.com", "contract america gingrich messaging republican", "Contract with America (Archive)", "Republican", "message-guidance", 2),
  rove_archive: makeSearchScraper("rove.com", "karl rove republican strategy messaging memo", "Karl Rove (Archive)", "Republican", "message-guidance", 2),
  fabrizio: makeSearchScraper("fabriziolee.com", "tony fabrizio republican polling memo strategy", "Fabrizio Lee & Associates", "Republican", "polling-memo", 2),
  wpa_intelligence: makeSearchScraper("wpaintel.com", "republican polling messaging memo strategy", "WPA Intelligence", "Republican", "polling-memo", 2),
  public_opinion_strategies: makeSearchScraper("pos.org", "republican polling memo messaging battleground", "Public Opinion Strategies", "Republican", "polling-memo", 3),
  mclaughlin_associates: makeSearchScraper("mclaughlinonline.com", "mclaughlin republican polling memo messaging", "McLaughlin & Associates", "Republican", "polling-memo", 2),
  tarrance: makeSearchScraper("tarrance.com", "tarrance republican polling memo messaging", "The Tarrance Group", "Republican", "polling-memo", 2),
  ayres_mchenry: makeSearchScraper("ayresmchenry.com", "ayres republican polling memo messaging", "Ayres, McHenry & Associates", "Republican", "polling-memo", 2),
  oncampaigns: makeSearchScraper("oncampaigns.com", "campaigns elections strategy practitioner memo", "Campaigns & Elections", "Independent", "message-guidance", 2),
  cei_archive: makeSearchScraper("web.archive.org/web/*/cei.org", "competitive enterprise conservative archive messaging", "CEI Archive", "Republican", "message-guidance", 2),
  cnp_archive: makeSearchScraper("web.archive.org/web/*/cfnp.org", "council national policy conservative coalition memo", "CNP Archive", "Republican", "message-guidance", 2),
  family_research_archive: makeSearchScraper("web.archive.org/web/*/frc.org", "family values social conservative messaging archive", "FRC Archive", "Republican", "message-guidance", 2),
  americans_for_tax_reform_archive: makeSearchScraper("web.archive.org/web/*/atr.org", "norquist tax pledge conservative memo archive", "ATR Archive", "Republican", "message-guidance", 2),
  cnp_council: makeSearchScraper("cfnp.org", "conservative coalition strategy memo policy", "Council for National Policy", "Republican", "message-guidance", 2),

  // Independent / nonpartisan historical pollster & polling memo libraries
  roper_center: makeSearchScraper("ropercenter.cornell.edu", "polling archive historical public opinion data", "Roper Center for Public Opinion", "Independent", "polling-memo", 3),
  pew_archive: makeSearchScraper("web.archive.org/web/*/pewresearch.org", "polling historical public opinion memo", "Pew Historical Archive", "Independent", "polling-memo", 2),
  gallup_archive: makeSearchScraper("news.gallup.com", "polling historical public opinion approval trend", "Gallup Historical", "Independent", "polling-memo", 3),
  abc_news_polls: makeSearchScraper("abcnews.go.com/Politics/PollVault", "abc washington post poll historical voter", "ABC News/Washington Post Poll", "Independent", "polling-memo", 2),
  cbs_news_polls: makeSearchScraper("cbsnews.com", "cbs news poll historical voter survey", "CBS News Poll", "Independent", "polling-memo", 2),
  nbc_wsj_polls: makeSearchScraper("nbcnews.com", "nbc wall street journal poll historical voter", "NBC/WSJ Poll", "Independent", "polling-memo", 2),
  nyt_upshot: makeSearchScraper("nytimes.com/section/upshot", "upshot polling analysis voter electoral", "NYT The Upshot", "Independent", "polling-memo", 2),
  fivethirtyeight_msg: makeSearchScraper("fivethirtyeight.com", "polling analysis forecasting voter messaging", "FiveThirtyEight", "Independent", "polling-memo", 3),
  cook_political: makeSearchScraper("cookpolitical.com", "cook political race rating messaging analysis", "Cook Political Report", "Independent", "policy-analysis", 2),
  sabato_crystal: makeSearchScraper("centerforpolitics.org", "sabato crystal ball ratings analysis messaging", "Sabato's Crystal Ball", "Independent", "policy-analysis", 2),
  inside_elections: makeSearchScraper("insideelections.com", "race ratings analysis competitive district memo", "Inside Elections", "Independent", "policy-analysis", 2),
  ballotpedia_msg: makeSearchScraper("ballotpedia.org", "candidate messaging policy positions historical", "Ballotpedia", "Independent", "policy-analysis", 2),
  pew_internet: makeSearchScraper("pewresearch.org/internet", "internet technology polling public opinion historical", "Pew Internet & Technology", "Independent", "polling-memo", 2),
  pew_journalism: makeSearchScraper("pewresearch.org/journalism", "journalism news media public opinion polling", "Pew Journalism", "Independent", "polling-memo", 2),
  pew_religion: makeSearchScraper("pewresearch.org/religion", "religion public opinion polling religious voter", "Pew Religion & Public Life", "Independent", "polling-memo", 2),
  pew_hispanic: makeSearchScraper("pewresearch.org/hispanic", "hispanic latino polling voter public opinion", "Pew Hispanic Trends", "Independent", "polling-memo", 2),
  edison_research: makeSearchScraper("edisonresearch.com", "exit poll election day voter survey", "Edison Research", "Independent", "polling-memo", 2),
  ssrs: makeSearchScraper("ssrs.com", "polling survey research methodology public opinion", "SSRS", "Independent", "polling-memo", 2),
  yougov: makeSearchScraper("today.yougov.com", "yougov polling public opinion tracking voter", "YouGov", "Independent", "polling-memo", 3),
  reuters_ipsos: makeSearchScraper("reuters.com/world/us", "reuters ipsos polling voter public opinion", "Reuters/Ipsos Poll", "Independent", "polling-memo", 2),
  emerson_polling: makeSearchScraper("emersonpolling.com", "emerson polling state national voter survey", "Emerson College Polling", "Independent", "polling-memo", 2),
  monmouth_poll: makeSearchScraper("monmouth.edu/polling-institute", "monmouth polling national state voter survey", "Monmouth University Poll", "Independent", "polling-memo", 2),
  siena_research: makeSearchScraper("scri.siena.edu", "siena polling new york national voter survey", "Siena College Research Institute", "Independent", "polling-memo", 2),
  suffolk_polling: makeSearchScraper("suffolk.edu/academics/research-at-suffolk/political-research-center", "suffolk polling state voter survey memo", "Suffolk University Political Research Center", "Independent", "polling-memo", 2),
  fox_news_poll: makeSearchScraper("foxnews.com/politics/fox-news-poll", "fox news poll voter survey approval", "Fox News Poll", "Independent", "polling-memo", 2),
  cnn_polls: makeSearchScraper("cnn.com/specials/politics/cnn-polls", "cnn poll voter survey approval national", "CNN Polls", "Independent", "polling-memo", 2),
  marquette_law: makeSearchScraper("law.marquette.edu/poll", "marquette law school poll wisconsin national survey", "Marquette Law School Poll", "Independent", "polling-memo", 2),
  npr_pbs_marist: makeSearchScraper("maristpoll.marist.edu/polls", "npr pbs marist poll national voter survey", "NPR/PBS NewsHour/Marist Poll", "Independent", "polling-memo", 2),

  // Government & academic message research archives
  congress_gov_archive: makeSearchScraper("congress.gov", "floor speech messaging memo committee report", "Congress.gov", "Independent", "policy-analysis", 2),
  presidency_project: makeSearchScraper("presidency.ucsb.edu", "american presidency project speeches messaging historical", "American Presidency Project (UCSB)", "Independent", "policy-analysis", 2),
  miller_center: makeSearchScraper("millercenter.org", "presidential speeches messaging strategy historical", "Miller Center (UVA)", "Independent", "policy-analysis", 2),
  c_span_archives: makeSearchScraper("c-spanvideo.org", "c-span video congressional messaging historical", "C-SPAN Archives", "Independent", "policy-analysis", 2),
  govinfo_msg: makeSearchScraper("govinfo.gov", "congressional record committee report messaging", "GovInfo", "Independent", "policy-analysis", 2),

  /* ── Expansion: more pollsters, message labs, journals, and historical archives ── */
  way_to_win: makeSearchScraper("waytowin.us", "narrative power building messaging memo democratic", "Way to Win", "Democrat", "message-guidance", 3),
  narrative_initiative: makeSearchScraper("narrativeinitiative.org", "narrative shift messaging strategy progressive", "Narrative Initiative", "Democrat", "message-guidance", 2),
  opportunity_agenda: makeSearchScraper("opportunityagenda.org", "narrative justice equity messaging research memo", "Opportunity Agenda", "Democrat", "message-guidance", 2),
  race_class_narrative: makeSearchScraper("demos.org", "race class narrative messaging research progressive", "Race-Class Narrative Project", "Democrat", "message-guidance", 2),
  hattaway_comm: makeSearchScraper("hattaway.com", "hattaway messaging communications progressive memo", "Hattaway Communications", "Democrat", "message-guidance", 2),
  spitfire_strategies: makeSearchScraper("spitfirestrategies.com", "advocacy communications nonprofit messaging strategy", "Spitfire Strategies", "Democrat", "message-guidance", 2),
  fenton_communications: makeSearchScraper("fenton.com", "social impact communications progressive messaging", "Fenton Communications", "Democrat", "message-guidance", 2),
  blue_state_digital: makeSearchScraper("bluestate.co", "digital organizing messaging democratic strategy", "Blue State", "Democrat", "message-guidance", 2),
  precision_strategies: makeSearchScraper("precisionstrategies.com", "data driven messaging democratic strategy", "Precision Strategies", "Democrat", "message-guidance", 2),
  mellman_group: makeSearchScraper("mellmangroup.com", "mark mellman democratic polling memo strategy", "The Mellman Group", "Democrat", "polling-memo", 3),
  brilliant_corners: makeSearchScraper("brilliantcorners.com", "cornell belcher polling democratic memo coalition", "Brilliant Corners Research", "Democrat", "polling-memo", 2),
  change_research_msg: makeSearchScraper("changeresearch.com", "online polling democratic messaging research memo", "Change Research", "Democrat", "polling-memo", 2),
  blueprint_polling: makeSearchScraper("blueprintpolling.com", "blueprint democratic polling message research", "Blueprint Polling", "Democrat", "polling-memo", 2),
  arena_summit: makeSearchScraper("arena.run", "democratic candidate training messaging strategy", "Arena", "Democrat", "message-guidance", 2),
  run_for_something: makeSearchScraper("runforsomething.net", "young democratic candidate recruitment messaging", "Run for Something", "Democrat", "message-guidance", 2),
  states_project: makeSearchScraper("statesproject.org", "state legislative chamber democratic strategy", "The States Project", "Democrat", "message-guidance", 2),
  yale_climate_communication: makeSearchScraper("climatecommunication.yale.edu", "yale climate change communication messaging research", "Yale Program on Climate Communication", "Independent", "polling-memo", 3),
  george_mason_climate: makeSearchScraper("climatechangecommunication.org", "george mason climate communication messaging research", "Center for Climate Change Communication (GMU)", "Independent", "polling-memo", 2),
  // Republican: more pollsters and firms
  cygnal_polling: makeSearchScraper("cygn.al", "cygnal republican polling memo strategy", "Cygnal", "Republican", "polling-memo", 3),
  remington_research: makeSearchScraper("remingtonresearch.com", "republican polling memo strategy state national", "Remington Research Group", "Republican", "polling-memo", 2),
  trafalgar_group: makeSearchScraper("thetrafalgargroup.org", "trafalgar republican polling memo battleground", "The Trafalgar Group", "Republican", "polling-memo", 3),
  rasmussen_polls: makeSearchScraper("rasmussenreports.com", "rasmussen polling tracker republican voter", "Rasmussen Reports", "Republican", "polling-memo", 2),
  insider_advantage: makeSearchScraper("insideradvantage.com", "matt towery polling republican memo state", "InsiderAdvantage", "Republican", "polling-memo", 2),
  echelon_insights: makeSearchScraper("echeloninsights.com", "republican strategy polling memo data analytics", "Echelon Insights", "Republican", "polling-memo", 3),
  resurgent_republic: makeSearchScraper("resurgentrepublic.com", "republican polling messaging memo strategy", "Resurgent Republic", "Republican", "polling-memo", 3),
  basswood_research: makeSearchScraper("basswoodresearch.com", "basswood republican polling memo strategy", "Basswood Research", "Republican", "polling-memo", 2),
  axiom_strategies: makeSearchScraper("axiomstrategies.com", "axiom republican strategy memo campaign", "Axiom Strategies", "Republican", "message-guidance", 2),
  onmessage_inc: makeSearchScraper("onmessageinc.com", "onmessage republican media strategy memo", "OnMessage Inc.", "Republican", "message-guidance", 2),
  targeted_victory: makeSearchScraper("targetedvictory.com", "targeted victory republican digital memo strategy", "Targeted Victory", "Republican", "message-guidance", 2),
  fp1_strategies: makeSearchScraper("fp1strategies.com", "fp1 republican strategy memo campaign", "FP1 Strategies", "Republican", "message-guidance", 2),
  north_star_opinion: makeSearchScraper("northstaropinion.com", "north star opinion republican polling memo", "North Star Opinion Research", "Republican", "polling-memo", 2),
  moore_information: makeSearchScraper("mooreinformation.com", "moore information republican polling memo", "Moore Information Group", "Republican", "polling-memo", 2),
  meeting_street_insights: makeSearchScraper("meetingstreetinsights.com", "meeting street republican polling memo south", "Meeting Street Insights", "Republican", "polling-memo", 2),
  america_first_policy_inst: makeSearchScraper("americafirstpolicy.com", "america first conservative populist memo", "America First Policy Institute", "Republican", "message-guidance", 2),
  // Independent / academic / archives
  anes_data: makeSearchScraper("electionstudies.org", "american national election studies polling research", "ANES (American National Election Studies)", "Independent", "polling-memo", 3),
  cces_data: makeSearchScraper("cces.gov.harvard.edu", "cooperative election study harvard polling research", "CCES (Cooperative Election Study)", "Independent", "polling-memo", 2),
  general_social_survey: makeSearchScraper("gss.norc.org", "general social survey norc polling memo", "GSS (General Social Survey)", "Independent", "polling-memo", 2),
  living_room_candidate: makeSearchScraper("livingroomcandidate.org", "living room candidate presidential ads historical", "The Living Room Candidate", "Independent", "policy-analysis", 3),
  vanderbilt_television: makeSearchScraper("tvnews.vanderbilt.edu", "vanderbilt television news archive historical", "Vanderbilt TV News Archive", "Independent", "policy-analysis", 2),
  marquette_supreme: makeSearchScraper("law.marquette.edu", "marquette supreme court polling memo", "Marquette SCOTUS Poll", "Independent", "polling-memo", 2),
  pew_global: makeSearchScraper("pewresearch.org/global", "pew global attitudes international public opinion", "Pew Global Attitudes", "Independent", "polling-memo", 2),
  pew_social: makeSearchScraper("pewresearch.org/social-trends", "pew social demographic trends polling memo", "Pew Social & Demographic Trends", "Independent", "polling-memo", 2),
  punchbowl_news: makeSearchScraper("punchbowl.news", "punchbowl congressional messaging memo", "Punchbowl News", "Independent", "message-guidance", 2),
  semafor_principals: makeSearchScraper("semafor.com", "semafor principals washington messaging memo", "Semafor Principals", "Independent", "message-guidance", 2),
  daily_kos_archive: makeSearchScraper("web.archive.org/web/*/dailykos.com", "progressive netroots messaging strategy historical", "Daily Kos (Archive)", "Democrat", "message-guidance", 2),
  redstate_archive: makeSearchScraper("web.archive.org/web/*/redstate.com", "conservative grassroots messaging historical archive", "RedState (Archive)", "Republican", "message-guidance", 2),
  pollster_com_archive: makeSearchScraper("web.archive.org/web/*/pollster.com", "pollster aggregation historical polling archive", "Pollster.com (Archive)", "Independent", "polling-memo", 2),
  realclearpolitics_archive: makeSearchScraper("web.archive.org/web/*/realclearpolitics.com", "rcp historical polling average archive", "RealClearPolitics (Archive)", "Independent", "polling-memo", 2),
};
