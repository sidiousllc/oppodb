...
const SOURCES: Record<string, Array<{ name: string; rssUrl: string; scope: string }>> = {
  ...
  __unused_old_local: [
    { name: "_legacy", rssUrl: "https://example.invalid/feed", scope: "local" },
    ...
    // Additional local & community outlets
    { name: "Mission Local (SF)", rssUrl: "https://missionlocal.org/feed/", scope: "local" },
    { name: "The Frisc", rssUrl: "https://thefrisc.com/feed/", scope: "local" },
    { name: "Outlier Media (Detroit)", rssUrl: "https://outliermedia.org/feed/", scope: "local" },
    { name: "Sahan Journal (MN)", rssUrl: "https://sahanjournal.com/feed/", scope: "local" },
    { name: "Resolve Philly", rssUrl: "https://resolvephilly.org/feed/", scope: "local" },
    { name: "El Tímpano (Bay Area)", rssUrl: "https://eltimpano.org/feed/", scope: "local" },
    { name: "Cardinal News (VA)", rssUrl: "https://cardinalnews.org/feed/", scope: "local" },
    { name: "The Beacon (KC)", rssUrl: "https://thebeacon.media/feed/", scope: "local" },
    { name: "WyoFile", rssUrl: "https://wyofile.com/feed/", scope: "local" },
    { name: "InvestigateWest", rssUrl: "https://www.invw.org/feed/", scope: "local" },
    { name: "The Lens NOLA", rssUrl: "https://thelensnola.org/feed/", scope: "local" },
    { name: "MLK50", rssUrl: "https://mlk50.com/feed/", scope: "local" },
    { name: "Cicero Independiente", rssUrl: "https://www.ciceroindependiente.com/feed", scope: "local" },
    { name: "WBEZ Chicago", rssUrl: "https://www.wbez.org/feed", scope: "local" },
    { name: "WBUR Boston", rssUrl: "https://www.wbur.org/feed", scope: "local" },
    // Expansion: more local & metro newsrooms
    { name: "Axios Local Hubs", rssUrl: "https://www.axios.com/local/feed", scope: "local" },
    { name: "BlockClub LA", rssUrl: "https://www.crosstown.la/feed/", scope: "local" },
    { name: "Hoodline", rssUrl: "https://hoodline.com/feed/", scope: "local" },
    { name: "Patch California", rssUrl: "https://patch.com/feeds/california", scope: "local" },
    { name: "Patch New York", rssUrl: "https://patch.com/feeds/new-york", scope: "local" },
    { name: "Patch Florida", rssUrl: "https://patch.com/feeds/florida", scope: "local" },
    { name: "Patch Texas", rssUrl: "https://patch.com/feeds/texas", scope: "local" },
    { name: "Patch Illinois", rssUrl: "https://patch.com/feeds/illinois", scope: "local" },
    { name: "WBEZ Curious City", rssUrl: "https://www.wbez.org/curiouscity/feed", scope: "local" },
    { name: "KQED News", rssUrl: "https://www.kqed.org/news/feed", scope: "local" },
    { name: "WHYY (Philly)", rssUrl: "https://whyy.org/feed/", scope: "local" },
    { name: "WAMU (DC)", rssUrl: "https://wamu.org/feed/", scope: "local" },
    { name: "DCist", rssUrl: "https://dcist.com/feed", scope: "local" },
    { name: "Baltimore Banner", rssUrl: "https://www.thebaltimorebanner.com/arc/outboundfeeds/rss/", scope: "local" },
    { name: "Baltimore Brew", rssUrl: "https://baltimorebrew.com/feed/", scope: "local" },
    { name: "Crain's Chicago Business", rssUrl: "https://www.chicagobusiness.com/rss.xml", scope: "local" },
    { name: "Crain's New York", rssUrl: "https://www.crainsnewyork.com/rss.xml", scope: "local" },
    { name: "Boston Herald Politics", rssUrl: "https://www.bostonherald.com/news/politics/feed/", scope: "local" },
    { name: "CommonWealth Beacon (MA)", rssUrl: "https://commonwealthbeacon.org/feed/", scope: "local" },
    { name: "Connecticut Post", rssUrl: "https://www.ctpost.com/news/feed/local-23.php", scope: "local" },
    { name: "Hartford Courant Politics", rssUrl: "https://www.courant.com/politics/feed/", scope: "local" },
    { name: "Atlanta Civic Circle", rssUrl: "https://atlantaciviccircle.org/feed/", scope: "local" },
    { name: "Atlanta Journal-Constitution Politics", rssUrl: "https://www.ajc.com/news/state-regional-govt-politics/feed/", scope: "local" },
    { name: "Charlotte Ledger", rssUrl: "https://charlotteledger.substack.com/feed", scope: "local" },
    { name: "Indianapolis Recorder", rssUrl: "https://www.indianapolisrecorder.com/feed/", scope: "local" },
    { name: "Cleveland.com Politics", rssUrl: "https://www.cleveland.com/politics/atom.xml", scope: "local" },
    { name: "Signal Cleveland", rssUrl: "https://signalcleveland.org/feed/", scope: "local" },
    { name: "Signal Akron", rssUrl: "https://signalakron.org/feed/", scope: "local" },
    { name: "Cincinnati Enquirer Politics", rssUrl: "https://rssfeeds.cincinnati.com/cincinnati/politics", scope: "local" },
    { name: "Pittsburgh Post-Gazette", rssUrl: "https://www.post-gazette.com/feed/feeds_local.xml", scope: "local" },
    { name: "Tampa Bay Times Politics", rssUrl: "https://www.tampabay.com/feed/", scope: "local" },
    { name: "Miami Herald Politics", rssUrl: "https://www.miamiherald.com/news/politics-government/article-rss.xml", scope: "local" },
    { name: "Phoenix New Times", rssUrl: "https://www.phoenixnewtimes.com/feed", scope: "local" },
    { name: "Tucson Sentinel", rssUrl: "https://www.tucsonsentinel.com/site/feed.xml", scope: "local" },
    { name: "Seattle Times Politics", rssUrl: "https://www.seattletimes.com/seattle-news/politics/feed/", scope: "local" },
    { name: "PubliCola (Seattle)", rssUrl: "https://publicola.com/feed/", scope: "local" },
    { name: "Crosscut", rssUrl: "https://crosscut.com/feed", scope: "local" },
    { name: "Portland Mercury", rssUrl: "https://www.portlandmercury.com/Rss.xml", scope: "local" },
    { name: "Willamette Week", rssUrl: "https://www.wweek.com/feed/", scope: "local" },
    { name: "Las Vegas Sun Politics", rssUrl: "https://lasvegassun.com/feeds/headlines/news/politics/", scope: "local" },
    { name: "Reno Gazette Journal", rssUrl: "https://rssfeeds.rgj.com/RGJ/News", scope: "local" },
    { name: "San Antonio Report", rssUrl: "https://sanantonioreport.org/feed/", scope: "local" },
    { name: "Houston Chronicle Politics", rssUrl: "https://www.houstonchronicle.com/rss/feed/Politics-291.php", scope: "local" },
    { name: "Dallas Morning News Politics", rssUrl: "https://www.dallasnews.com/arc/outboundfeeds/rss/category/news/politics/", scope: "local" },
    { name: "El Paso Matters", rssUrl: "https://elpasomatters.org/feed/", scope: "local" },
    { name: "South Florida Sun Sentinel", rssUrl: "https://www.sun-sentinel.com/news/politics/feed/", scope: "local" },
    { name: "Spotlight Delaware", rssUrl: "https://spotlightdelaware.org/feed/", scope: "local" },
    { name: "RVA Hub (Richmond)", rssUrl: "https://www.rvahub.com/feed/", scope: "local" },
    { name: "Chesapeake Bay Journal", rssUrl: "https://www.bayjournal.com/site/rss.xml", scope: "local" },
    // Expansion: more local newsrooms / city-hall coverage
    { name: "Voice of San Diego", rssUrl: "https://voiceofsandiego.org/feed/", scope: "local" },
    { name: "LAist", rssUrl: "https://laist.com/feeds/all", scope: "local" },
    { name: "Capital & Main", rssUrl: "https://capitalandmain.com/feed", scope: "local" },
    { name: "San Francisco Standard", rssUrl: "https://sfstandard.com/feed/", scope: "local" },
    { name: "Mission Local (SF)", rssUrl: "https://missionlocal.org/feed/", scope: "local" },
    { name: "Berkeleyside", rssUrl: "https://www.berkeleyside.org/feed", scope: "local" },
    { name: "Sacramento Bee Politics", rssUrl: "https://www.sacbee.com/news/politics-government/?widgetName=rssfeed&widgetContentId=15709873&getXmlFeed=true", scope: "local" },
    { name: "Houston Landing", rssUrl: "https://houstonlanding.org/feed/", scope: "local" },
    { name: "Houston Public Media", rssUrl: "https://www.houstonpublicmedia.org/feed/", scope: "local" },
    { name: "San Antonio Report", rssUrl: "https://sanantonioreport.org/feed/", scope: "local" },
    { name: "Austin Monitor", rssUrl: "https://www.austinmonitor.com/feed/", scope: "local" },
    { name: "Texas Tribune (Local)", rssUrl: "https://www.texastribune.org/feeds/", scope: "local" },
    { name: "Phoenix New Times", rssUrl: "https://www.phoenixnewtimes.com/atom/news.xml", scope: "local" },
    { name: "Tucson Sentinel", rssUrl: "https://www.tucsonsentinel.com/syndication/feed/news", scope: "local" },
    { name: "Denverite", rssUrl: "https://denverite.com/feed/", scope: "local" },
    { name: "Colorado Public Radio", rssUrl: "https://www.cpr.org/feed/", scope: "local" },
    { name: "Aspen Daily News", rssUrl: "https://www.aspendailynews.com/search/?f=rss", scope: "local" },
    { name: "Seattle Met (Local)", rssUrl: "https://www.seattlemet.com/news-and-city-life/rss", scope: "local" },
    { name: "The Stranger", rssUrl: "https://www.thestranger.com/rss/", scope: "local" },
    { name: "Portland Mercury", rssUrl: "https://www.portlandmercury.com/rss/", scope: "local" },
    { name: "Willamette Week", rssUrl: "https://www.wweek.com/feed/", scope: "local" },
    { name: "Boise Dev", rssUrl: "https://boisedev.com/feed/", scope: "local" },
    { name: "Idaho Press", rssUrl: "https://www.idahopress.com/search/?f=rss", scope: "local" },
    { name: "Honolulu Star-Advertiser", rssUrl: "https://www.staradvertiser.com/feed/", scope: "local" },
    { name: "Hawaii News Now", rssUrl: "https://www.hawaiinewsnow.com/arcio/rss/", scope: "local" },
    { name: "Anchorage Press", rssUrl: "https://www.anchoragepress.com/search/?f=rss", scope: "local" },
    { name: "Alaska Public Media", rssUrl: "https://alaskapublic.org/feed/", scope: "local" },
    { name: "Las Vegas Sun", rssUrl: "https://lasvegassun.com/feeds/headlines/news/", scope: "local" },
    { name: "Nevada Independent", rssUrl: "https://thenevadaindependent.com/feed", scope: "local" },
    { name: "Albuquerque Journal Politics", rssUrl: "https://www.abqjournal.com/category/news/politics/feed", scope: "local" },
    { name: "City Cast Network (US)", rssUrl: "https://citycast.fm/rss", scope: "local" },
    { name: "Indianapolis Recorder", rssUrl: "https://www.indianapolisrecorder.com/feed/", scope: "local" },
    { name: "Mirror Indy", rssUrl: "https://mirrorindy.org/feed/", scope: "local" },
    { name: "Crain's Chicago Business", rssUrl: "https://www.chicagobusiness.com/rss.xml", scope: "local" },
    { name: "Triibe (Chicago)", rssUrl: "https://thetriibe.com/feed/", scope: "local" },
    { name: "Injustice Watch (Chicago)", rssUrl: "https://www.injusticewatch.org/feed/", scope: "local" },
    { name: "Detroit Metro Times", rssUrl: "https://www.metrotimes.com/atom/news.xml", scope: "local" },
    { name: "BridgeDetroit", rssUrl: "https://www.bridgedetroit.com/feed/", scope: "local" },
    { name: "Outlier Media (Detroit)", rssUrl: "https://outliermedia.org/feed/", scope: "local" },
    { name: "Cleveland Scene", rssUrl: "https://www.clevescene.com/atom/news.xml", scope: "local" },
    { name: "Signal Cleveland", rssUrl: "https://signalcleveland.org/feed/", scope: "local" },
    { name: "Cincinnati Enquirer Politics", rssUrl: "https://rssfeeds.cincinnati.com/cincinnati/politics", scope: "local" },
    { name: "Eye on Ohio", rssUrl: "https://eyeonohio.com/feed/", scope: "local" },
    { name: "Boston.com News", rssUrl: "https://www.boston.com/feed/", scope: "local" },
    { name: "Universal Hub (Boston)", rssUrl: "https://www.universalhub.com/feed", scope: "local" },
    { name: "Berkshire Eagle", rssUrl: "https://www.berkshireeagle.com/search/?f=rss", scope: "local" },
    { name: "WNYC Local Politics", rssUrl: "https://www.wnyc.org/rss.xml", scope: "local" },
    { name: "Hellgate (NYC)", rssUrl: "https://hellgatenyc.com/feed", scope: "local" },
    { name: "Documented NY", rssUrl: "https://documentedny.com/feed/", scope: "local" },
    { name: "Bronx Times", rssUrl: "https://www.bxtimes.com/feed/", scope: "local" },
    { name: "Brooklyn Eagle", rssUrl: "https://brooklyneagle.com/feed/", scope: "local" },
    { name: "Queens Daily Eagle", rssUrl: "https://queenseagle.com/all?format=rss", scope: "local" },
    { name: "amNY (Schneps)", rssUrl: "https://www.amny.com/feed/", scope: "local" },
    { name: "NJ Spotlight News", rssUrl: "https://www.njspotlightnews.org/feed/", scope: "local" },
    { name: "Jersey Bites", rssUrl: "https://newjerseyglobe.com/feed/", scope: "local" },
    { name: "Philly Voice", rssUrl: "https://www.phillyvoice.com/feed/", scope: "local" },
    { name: "Billy Penn", rssUrl: "https://billypenn.com/feed/", scope: "local" },
    { name: "WHYY News", rssUrl: "https://whyy.org/feed/", scope: "local" },
    { name: "PublicSource (Pittsburgh)", rssUrl: "https://www.publicsource.org/feed/", scope: "local" },
    { name: "PG Politics", rssUrl: "https://www.post-gazette.com/rss/local/state-politics", scope: "local" },
    { name: "Baltimore Banner", rssUrl: "https://www.thebaltimorebanner.com/arc/outboundfeeds/rss/category/politics/", scope: "local" },
    { name: "Baltimore Brew", rssUrl: "https://www.baltimorebrew.com/feed/", scope: "local" },
    { name: "Washington City Paper", rssUrl: "https://washingtoncitypaper.com/feed/", scope: "local" },
    { name: "Greater Greater Washington", rssUrl: "https://ggwash.org/atom.xml", scope: "local" },
    { name: "ARLnow (Arlington VA)", rssUrl: "https://www.arlnow.com/feed/", scope: "local" },
    { name: "FFXnow (Fairfax)", rssUrl: "https://www.ffxnow.com/feed/", scope: "local" },
    { name: "Charlotte Observer Politics", rssUrl: "https://www.charlotteobserver.com/news/politics-government/?widgetName=rssfeed&widgetContentId=15750881&getXmlFeed=true", scope: "local" },
    { name: "Triangle Business Journal", rssUrl: "https://www.bizjournals.com/triangle/news/politics/feed", scope: "local" },
    { name: "WRAL Politics", rssUrl: "https://www.wral.com/news/political/?format=rss", scope: "local" },
    { name: "Atlanta Civic Circle", rssUrl: "https://atlantaciviccircle.org/feed/", scope: "local" },
    { name: "Capital B Atlanta", rssUrl: "https://atlanta.capitalbnews.org/feed/", scope: "local" },
    { name: "Saporta Report (ATL)", rssUrl: "https://saportareport.com/feed/", scope: "local" },
    { name: "Birmingham Watch", rssUrl: "https://birminghamwatch.org/feed/", scope: "local" },
    { name: "Memphis Flyer", rssUrl: "https://www.memphisflyer.com/atom/news.xml", scope: "local" },
    { name: "MetroSource (Nashville)", rssUrl: "https://www.tennessean.com/news/politics/?widgetName=rssfeed&widgetContentId=15750881&getXmlFeed=true", scope: "local" },
    { name: "Nashville Banner", rssUrl: "https://nashvillebanner.com/feed/", scope: "local" },
    { name: "Cardinal News (VA)", rssUrl: "https://cardinalnews.org/feed/", scope: "local" },
    { name: "Mountain State Spotlight (WV)", rssUrl: "https://mountainstatespotlight.org/feed/", scope: "local" },
    { name: "Lexington Herald-Leader Politics", rssUrl: "https://www.kentucky.com/news/politics-government/?widgetName=rssfeed&widgetContentId=15750881&getXmlFeed=true", scope: "local" },
    { name: "Louisiana Illuminator (Local)", rssUrl: "https://lailluminator.com/feed/", scope: "local" },
    { name: "Verite News (NOLA)", rssUrl: "https://veritenews.org/feed/", scope: "local" },
    { name: "The Lens (NOLA)", rssUrl: "https://thelensnola.org/feed/", scope: "local" },
    { name: "Mississippi Free Press", rssUrl: "https://www.mississippifreepress.org/feed/", scope: "local" },
    { name: "Tampa Bay Times Politics", rssUrl: "https://www.tampabay.com/arc/outboundfeeds/rss/category/news/florida-politics/", scope: "local" },
    { name: "Orlando Sentinel Politics", rssUrl: "https://www.orlandosentinel.com/news/politics/feed/", scope: "local" },
    { name: "Miami Herald Politics", rssUrl: "https://www.miamiherald.com/news/politics-government/?widgetName=rssfeed&widgetContentId=15709873&getXmlFeed=true", scope: "local" },
    { name: "WLRN Miami", rssUrl: "https://www.wlrn.org/feed", scope: "local" },
  ],
};
