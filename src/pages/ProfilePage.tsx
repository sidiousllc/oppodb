...
export default function ProfilePage() {
  ...
  const initialTab = (() => {
    ...
    return (VALID_TABS as readonly string[]).includes(t || "") ? (t as ProfileTab) : "account";
  })();
  ...
  // Keep URL in sync with active tab so deep-links from the taskbar work
  useEffect(() => {
    ...
    <Win98PageLayout title="Profile Settings" icon="👤" addressUrl="aol://ordb.research/profile">
      <Tabs value={tab} onValueChange={(v) => setTab(v as ProfileTab)} className="w-full">
        ...
        <TabsContent value="appearance" className="space-y-3 mt-0">
          ...
          {/* News Ticker */}
          <div className="win98-raised bg-[hsl(var(--win98-face))] p-3">
            <p className="text-[11px] font-bold mb-2 flex items-center gap-1">📰 News Ticker</p>
            <NewsTickerSettings />
          </div>
        </TabsContent>
        ...
        <TabsContent value="notifications" className="space-y-3 mt-0">
          <div className="win98-raised bg-[hsl(var(--win98-face))] p-3">
            <h2 className="text-[11px] font-bold mb-2">📧 Email Alerts &amp; Notifications</h2>
            <PollingAlertsManager />
          </div>
          <div className="win98-raised bg-[hsl(var(--win98-face))] p-3">
            <h2 className="text-[11px] font-bold mb-2">🔔 Alert Rules &amp; Webhooks</h2>
        ...
        <TabsContent value="integrations" className="space-y-3 mt-0">
          <div className="win98-raised bg-[hsl(var(--win98-face))] p-3">
            <p className="text-[11px] font-bold mb-2 flex items-center gap-1">📈 Prediction Market API Keys</p>
        ...
        <TabsContent value="network" className="space-y-3 mt-0">
          <div className="win98-raised bg-[hsl(var(--win98-face))] p-3">
            <p className="text-[11px] font-bold mb-2 flex items-center gap-1">📡 Network &amp; Offline Mode</p>
