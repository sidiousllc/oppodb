...
const BIAS_RULES: Array<{ match: string; bias: Bias }> = [
  ...
  { match: "city journal", bias: "right" },
  { match: "spectator", bias: "right" },
  { match: "american greatness", bias: "right" },
  { match: "american thinker", bias: "right" },
  { match: "american mind", bias: "right" },
  { match: "real america's voice", bias: "right" },
  { match: "right side broadcasting", bias: "right" },
  { match: "rsbn", bias: "right" },
  { match: "world net daily", bias: "right" },
  { match: "wnd", bias: "right" },
  { match: "lifesite", bias: "right" },
  { match: "cns news", bias: "right" },
  { match: "sinclair", bias: "lean-right" },
  { match: "newsbusters", bias: "right" },
  { match: "bongino", bias: "right" },
  { match: "rumble", bias: "right" },
  { match: "truth social", bias: "right" },

  // Additional center / wires
  { match: "dpa", bias: "center" },
  { match: "anadolu", bias: "center" },
  { match: "tass", bias: "lean-right" },
  { match: "rt ", bias: "right" },
  { match: "russia today", bias: "right" },
  { match: "xinhua", bias: "lean-left" },
  { match: "global times", bias: "lean-left" },
  { match: "south china morning", bias: "center" },
  { match: "scmp", bias: "center" },
  { match: "straits times", bias: "center" },
  { match: "the hindu", bias: "lean-left" },
  { match: "times of india", bias: "center" },
  { match: "haaretz", bias: "lean-left" },
  { match: "jerusalem post", bias: "lean-right" },
  { match: "times of israel", bias: "center" },
  { match: "al jazeera", bias: "lean-left" },
  { match: "al arabiya", bias: "lean-right" },
  { match: "the conversation", bias: "lean-left" },
  { match: "abc.net.au", bias: "center" },
  { match: "cbc", bias: "lean-left" },
  { match: "ctv", bias: "center" },
  { match: "globe and mail", bias: "center" },
  { match: "national post", bias: "lean-right" },
  { match: "toronto star", bias: "lean-left" },

  // Additional state-house wires
  { match: "spotlight pa", bias: "lean-left" },
  { match: "spotlight on poverty", bias: "lean-left" },
  { match: "mississippi today", bias: "lean-left" },
  { match: "tennessee lookout", bias: "lean-left" },
  { match: "new mexico in depth", bias: "lean-left" },
  { match: "alabama reflector", bias: "lean-left" },
  { match: "wyoming news now", bias: "center" },
  { match: "west virginia watch", bias: "lean-left" },
  { match: "rhode island current", bias: "lean-left" },
  { match: "vermont digger", bias: "lean-left" },
  { match: "vt digger", bias: "lean-left" },

  // Local/regional dailies (default to lean-left for major metros, lean-right for tabloids)
  { match: "los angeles times", bias: "lean-left" },
  { match: "chicago tribune", bias: "center" },
  { match: "chicago sun-times", bias: "lean-left" },
  { match: "boston globe", bias: "lean-left" },
  { match: "boston herald", bias: "lean-right" },
  { match: "philadelphia inquirer", bias: "lean-left" },
  { match: "miami herald", bias: "lean-left" },
  { match: "tampa bay times", bias: "lean-left" },
  { match: "atlanta journal", bias: "lean-left" },
  { match: "houston chronicle", bias: "center" },
  { match: "dallas morning news", bias: "lean-right" },
  { match: "san francisco chronicle", bias: "lean-left" },
  { match: "seattle times", bias: "lean-left" },
  { match: "denver post", bias: "center" },
  { match: "minneapolis star tribune", bias: "lean-left" },
  { match: "star tribune", bias: "lean-left" },
  { match: "detroit free press", bias: "lean-left" },
  { match: "detroit news", bias: "lean-right" },
  { match: "milwaukee journal", bias: "lean-left" },
  { match: "cleveland.com", bias: "center" },
  { match: "plain dealer", bias: "lean-left" },
  { match: "kansas city star", bias: "lean-left" },
  { match: "st. louis post", bias: "center" },
  { match: "st louis post", bias: "center" },
  { match: "arizona republic", bias: "lean-left" },
  { match: "denver gazette", bias: "lean-right" },
  { match: "colorado sun", bias: "center" },
  { match: "san diego union", bias: "center" },
  { match: "orange county register", bias: "lean-right" },
];
