...
export function GraphHub() {
  ...
  return (
      <div className="space-y-3">
        <div className="flex justify-end gap-2 items-center"><OfflineSectionDownloadButton label="Graph" tables={["entity_relationships","graph_snapshots"]} /><OfflineSectionStatus label="Graph" tables={["entity_relationships","graph_snapshots"]} /></div>
